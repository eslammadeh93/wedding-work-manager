...
/** A shared in-app control. Workers activate it once; managerial accounts can
 * keep using it to enable or disable pushes on the current browser. */
