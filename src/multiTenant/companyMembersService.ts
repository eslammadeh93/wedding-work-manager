...
export type CreateCompanyMemberRequest = { name: string; role: ManagedCompanyRole; email?: string; temporaryPassword?: string; jobTitle?: string; username?: string; loginCode?: string; phone?: string };
