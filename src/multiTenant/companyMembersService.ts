...
export type CreateCompanyMemberRequest = { name: string; role: ManagedCompanyRole; email?: string; temporaryPassword?: string; jobTitle?: string; username?: string; loginCode?: string; phone?: string; notes?: string };
export type UpdateCompanyMemberRequest = { uid: string; name?: string; phone?: string; jobTitle?: string; displaySettings?: Record<string, boolean | string | number> };
