...
export function PlatformDashboard({ navigate, createCompany }: { navigate: (path: string) => void; createCompany?: () => void }) {
  ...
  return <section>
    <PlatformPageHeader title="لوحة المنصة" description="مؤشرات تشغيلية مجمعة وآمنة لأداء المنصة والشركات." actions={createCompany ? <PlatformButton onClick={createCompany}><Plus size={17} />إنشاء شركة</PlatformButton> : undefined} />
