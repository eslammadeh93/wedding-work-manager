...
/** Central source of truth for the clean-start multi-tenant Firestore paths. */
export const firestorePaths = {
  ...
  workTasks: (companyId: string) => companyCollection(companyId, 'workTasks'),
  customers: (companyId: string) => companyCollection(companyId, 'customers'),
  suppliers: (companyId: string) => companyCollection(companyId, 'suppliers'),
  workers: (companyId: string) => companyCollection(companyId, 'workers'),
  workerOrders: (companyId: string) => companyCollection(companyId, 'workerOrders'),
  workerOrderContacts: (companyId: string) => companyCollection(companyId, 'workerOrderContacts'),
  workerSecrets: (companyId: string) => companyCollection(companyId, 'workerSecrets'),
  ...
  auditLogs: (companyId: string) => companyCollection(companyId, 'auditLogs'),
  ...
  workTask: (companyId: string, taskId: string) => `${companyRoot(companyId)}/workTasks/${documentId(taskId, 'taskId')}`,
  ...
  supplier: (companyId: string, supplierId: string) => `${companyRoot(companyId)}/suppliers/${documentId(supplierId, 'supplierId')}`,
