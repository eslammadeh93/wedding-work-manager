...
export const COMPANY_PERMISSION_GROUPS: ReadonlyArray<{ title: string; permissions: readonly Permission[] }> = [
  ...
  { title: 'التشغيل والمخزون', permissions: ['company:workers:read', 'company:workers:write', 'company:inventory:read', 'company:inventory:write', 'company:categories:read', 'company:categories:write'] },
