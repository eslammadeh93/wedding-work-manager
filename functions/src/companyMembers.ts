...
const COMPANY_PERMISSIONS: readonly CompanyPermission[] = ['company:dashboard:read', 'company:calendar:read', 'company:orders:read', 'company:orders:write', 'company:customers:read', 'company:customers:write', 'company:suppliers:read', 'company:suppliers:write', 'company:workers:read', 'company:workers:write', 'company:worker_performance:read', 'company:inventory:read', 'company:inventory:write', 'company:expenses:read', 'company:expenses:write', 'company:categories:read', 'company:categories:write', 'company:activity_logs:read', 'company:reports:read', 'company:settings:read', 'company:settings:write', 'company:members:read', 'company:members:write', 'company:notifications:read'];
const legacyPermissions = (role: CompanyRole): readonly CompanyPermission[] => role === 'company_super_admin' ? COMPANY_PERMISSIONS : role === 'manager' ? COMPANY_PERMISSIONS.filter(permission => !permission.startsWith('company:expenses:')) : role === 'employee' ? ['company:dashboard:read', 'company:calendar:read', 'company:orders:read', 'company:orders:write', 'company:customers:read', 'company:customers:write', 'company:inventory:read', 'company:notifications:read'] : ['company:orders:read', 'company:worker_performance:read', 'company:notifications:read'];
