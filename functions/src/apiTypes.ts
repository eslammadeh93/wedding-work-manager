...
export interface CreateCompanyRequest { companyName: string; slug: string; companyCode: string; ownerName: string; ownerEmail: string; ownerPassword: string; plan: string; subscriptionStart: string; subscriptionEnd: string; maxUsers: number; features: string[]; }
